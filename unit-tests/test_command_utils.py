...
from ycommander.commands import utils
...
class TestRegister(TestCase):
    ...
    def test_login(self):
        ...
        with mock.patch('builtins.input') as mock_input, \
                ...
                mock.patch('ycommander.api.login') as mock_login:
    ...
    def test_enterprise_invite(self):
        ...
        with mock.patch('builtins.print'), mock.patch('ycommander.commands.utils.user_choice') as m_choice, mock.patch('builtins.input') as m_input:
    ...
    def test_account_transfer_consent(self):
        ...
        cmd = utils.CheckEnforcementsCommand()
        with mock.patch('builtins.print'), mock.patch('ycommander.api.accept_account_transfer_consent') as m_transfer:
